...
namespace Conembador.Controllers
{
    public class ItemController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> EnviarRespostas(List<Item> Itens, int Id_arquivo)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //return View("~/Views/Edi/ApresentarEdi.cshtml"); // esta parte precisa melhorar para não ficar estranho quando o usuário salva os itens.
            }
        ...
        private async Task<ViewResult> CadastrarItem(List<Item> itens, int Id_arquivo)
        {
            if (ModelState.IsValid)
            {
